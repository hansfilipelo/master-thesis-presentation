...
\documentclass[noamsthm, english, handout]{beamer}
...
\finaltext{Hans-Filip Elo \\ ~\\ [-0.5em]%
    \small \href{hanel742@student.liu.se}%
{hanel742@student.liu.se}\vspace{0.5em}}
...
\section{Why look at QUIC?}
%\makeoutline
\LiUframe[green]{\frametitle{Why look at QUIC?}}
\include{why-quic-opera}

\section{My test and my contributions}
%\makeoutline
\LiUframe[green]{\frametitle{My test and my contributions}}
\include{my-testbed-opera}

\section{Results}
%\makeoutline
\LiUframe[green]{\frametitle{Results}}
\include{results}
\LiUframe[green]{\frametitle{Questions?}}

\section{Demo: Network limited shell}
\LiUframe[green]{\frametitle{Demo}}
